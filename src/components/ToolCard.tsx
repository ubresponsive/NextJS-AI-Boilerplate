...
const ToolCard: React.FC<ToolCardProps> = ({ 
  ...
  if (comingSoon) {
    return (
      <div className={`bg-gradient-to-br ${colors.bg} border ${colors.border} rounded-xl p-6 transition-all duration-200 opacity-75`}>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <h3 className={`text-lg font-semibold ${colors.text} group-hover:${colors.accent}`}>{title}</h3>
        {isActive && (
